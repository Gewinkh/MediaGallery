...
//  resolveRun/numLevel) zusammengesetzt und auf einen QPdfWriter paginiert.
//  Ergebnis = „wie die Editor-Ansicht", nur auf echte Seiten umbrochen:
//  fortlaufender Text, Tabellen als QTextTable, verankerte Bilder als
//  umflossener Rahmen; Platzhalter bleibt nur, was das Modell selbst nicht
//  zerlegen konnte. Abhängigkeiten: NUR Qt6::Gui (QTextDocument + QPdfWriter),
//  also KEINE neue Bibliothek (§0-Priorität 3).
//
