...
static const QMap<StringKey, QString> s_de = {
    ...
    { StringKey::BookmarkGroupDeleteText, "Die Gruppe und ihre Untergruppen werden entfernt - alle Ordner darin bleiben als Lesezeichen ohne Gruppe erhalten." },
    ...
    { StringKey::BookmarkDragHint,    "Am Griff ziehen: sortieren, in eine Gruppe geben oder eine Gruppe unter eine andere hängen." },
    { StringKey::BookmarkGroupNameTaken, "Der Name ist in dieser Ebene schon vergeben." },
    { StringKey::BookmarkGroupSubAdd,    "Untergruppe" },
    { StringKey::BookmarkGroupNameInvalid, "Ein Gruppenname darf keinen Schrägstrich enthalten." },
    { StringKey::BookmarkGroupParentLabel, "Liegt in:" },
    { StringKey::BookmarkGroupParentRoot,  "- oberste Ebene -" },
    ...
    { StringKey::TextReadOnlyBadge,             "Nur lesen" },
    { StringKey::TextReadOnlyTip,               "Die Datei ist groesser als 8 MB. Der Editor zeigt nur ihren Anfang, deshalb ist das Speichern gesperrt - sonst ginge der Rest der Datei verloren." },
    { StringKey::EditorStatusLineCol,           "Zeile %1, Spalte %2" },
    { StringKey::EditorStatusLines,             "Zeilen" },
    { StringKey::EditorStatusPlain,             "Text" },
    { StringKey::EditorStatusWrapOn,            "Umbruch" },
    { StringKey::SettingsEditorViewGroup,       "Ansicht" },
    { StringKey::SettingsEditorLineNumbers,     "Zeilennummern anzeigen" },
    { StringKey::SettingsEditorCurrentLine,     "Aktuelle Zeile hervorheben" },
    { StringKey::SettingsEditorSoftWrap,        "Lange Zeilen umbrechen" },
    { StringKey::SettingsEditorSoftWrapHint,    "Nur die Anzeige bricht um - die Datei bleibt unveraendert, ein echter Umbruch entsteht weiterhin nur mit der Eingabetaste. In der Nummernspalte bleiben die Fortsetzungszeilen leer. Aus: die Zeile laeuft waagerecht weiter." },
    { StringKey::SettingsEditorTabWidth,                "Tabulatorbreite" },
    { StringKey::SettingsEditorTabSpaces,               "Tabulatortaste fügt Leerzeichen ein" },
    { StringKey::SettingsEditorTabSpacesHint,           "An: die Tabulatortaste schreibt Leerzeichen bis zum nächsten Halt - so hält es Kate, und die Datei sieht in jedem Editor gleich aus, egal welche Tabulatorbreite dort eingestellt ist. Aus: es wird ein echtes Tabulatorzeichen geschrieben, dessen Breite jeder Editor selbst festlegt." },
    { StringKey::EditorFindPlaceholder,                 "Suchen …" },
    { StringKey::EditorReplacePlaceholder,              "Ersetzen durch …" },
    { StringKey::EditorFindPrev,                        "Vorheriger Treffer (Umschalt+Eingabe)" },
    { StringKey::EditorFindNext,                        "Nächster Treffer (Eingabe)" },
    { StringKey::EditorFindCase,                        "Groß-/Kleinschreibung beachten" },
    { StringKey::EditorFindWords,                       "Nur ganze Wörter" },
    { StringKey::EditorFindHighlight,                   "Alle Treffer hervorheben" },
    { StringKey::EditorFindClose,                       "Suche schließen (Esc)" },
    { StringKey::EditorFindReplaceOne,                  "Ersetzen" },
    { StringKey::EditorFindReplaceAll,                  "Alle ersetzen" },
    { StringKey::EditorFindNoMatch,                     "Kein Treffer" },
    { StringKey::EditorFindCounter,                     "%1 / %2" },
    { StringKey::EditorFindReplaced,                    "%1 ersetzt" },
    { StringKey::EditorMinimap,                         "Übersichtsspalte" },
    { StringKey::EditorMinimapTip,                      "Übersichtsspalte auf-/zuklappen" },
    { StringKey::EditorMinimapHint,                     "Zeigt die ganze Datei rechts stark verkleinert - als farbige Balken in den Farben der Syntaxfärbung, nicht als Text. Man erkennt daran die Form des Dokuments (Einrückungen, Blöcke, Leerzeilen) und kann darin scrollen. Kostet Breite, deshalb standardmäßig aus." },
    { StringKey::SettingsEditorExportTitle,                           "Editor-Farben sichern" },
    { StringKey::SettingsEditorImportTitle,                           "Editor-Farben laden" },
    ...
    { StringKey::EditorIndentGuidesHint,                              "Senkrechte Linien je Einrückungsstufe. Sie beantworten in tief verschachteltem Code die Frage, welche schließende Klammer wohin gehört." },
    { StringKey::EditorMatchBrackets,                                 "Klammernpaare hervorheben" },
    { StringKey::EditorMatchBracketsHint,                             "Steht der Cursor an einer Klammer, wird sie zusammen mit ihrer Partnerin hinterlegt. Fehlt die Partnerin, wird die Klammer rot - eine vergessene Klammer sieht man sonst erst beim Übersetzen." },
    { StringKey::SettingsSearchGroup,                                 "Suche mit Mustern (Regex)" },
    { StringKey::SettingsSearchTable,                                 ".\tein beliebiges Zeichen\n\\d\teine Ziffer (\\w Buchstabe oder Ziffer, \\s Leerraum)\n[abc]\teines dieser Zeichen ([^abc] keines davon)\n*\tkeinmal oder öfter (+ mindestens einmal, ? höchstens einmal)\n{4}\tgenau viermal ({2,5} zwei- bis fünfmal)\n^\tZeilenanfang ($ Zeilenende)\na|b\tentweder a oder b\n(…)\teine Gruppe\n\\.\tein echter Punkt - der Backslash entwertet ein Sonderzeichen" },
    { StringKey::SettingsSearchExamples,                              "^#include\tjede Include-Zeile\n\\d{4}\tjede vierstellige Zahl - und der Text \\d{4} selbst\nfarbe|color\tbeides auf einmal\n\\.jpg$\tDateinamen, die auf .jpg enden" },
    { StringKey::SettingsDesignBlockUi,                 "Oberfläche" },
    { StringKey::SettingsDesignBlockEditor,             "Text-Editor" },
    { StringKey::SettingsEditorProfileLabel,            "Editor-Profil" },
    { StringKey::SettingsEditorSurfaceGroup,            "Fläche" },
    { StringKey::SettingsEditorSyntaxGroup,             "Syntaxfarben" },
    { StringKey::SettingsEditorPreviewGroup,            "Vorschau" },
    { StringKey::SettingsEditorCustomHint,              "Die Farben lassen sich nur im Profil „Custom“ ändern. „Übernehmen“ kopiert das aktuelle Profil dorthin." },
    { StringKey::SettingsEditorSeedCustom,              "Übernehmen" },
    { StringKey::SettingsEditorResetColors,             "Zurücksetzen" },
    { StringKey::EditorColorBackground,                 "Hintergrund" },
    { StringKey::EditorColorText,                       "Schrift" },
    { StringKey::EditorColorCurrentLine,                "Aktuelle Zeile" },
    { StringKey::EditorColorSelection,                  "Auswahl" },
    { StringKey::EditorColorGutterBackground,           "Nummernspalte" },
    { StringKey::EditorColorGutterText,                 "Nummern" },
    { StringKey::EditorColorGutterTextActive,           "Aktuelle Nummer" },
    { StringKey::EditorColorKeyword,                    "Schlüsselwort" },
    { StringKey::EditorColorType,                       "Typ" },
    { StringKey::EditorColorString,                     "Zeichenkette" },
    { StringKey::EditorColorNumber,                     "Zahl" },
    { StringKey::EditorColorComment,                    "Kommentar" },
    { StringKey::EditorColorPreproc,                    "Präprozessor" },
    { StringKey::EditorColorFunction,                   "Funktion" },
    { StringKey::EditorColorOperator,                   "Operator" },
    { StringKey::EditorColorHeading,                    "Überschrift" },
    { StringKey::EditorColorEmphasis,                   "Betonung" },
    { StringKey::EditorColorLink,                       "Verweis" },
    { StringKey::EditorColorCode,                       "Code" },
...
static const QMap<StringKey, QString> s_en = {
    ...
    { StringKey::BookmarkGroupDeleteText, "The group and its subgroups are removed - every folder inside stays as a bookmark without a group." },
    ...
    { StringKey::BookmarkDragHint,    "Drag by the handle to sort, to drop into a group, or to nest one group inside another." },
    { StringKey::BookmarkGroupNameTaken, "That name is already used on this level." },
    { StringKey::BookmarkGroupSubAdd,    "Subgroup" },
    { StringKey::BookmarkGroupNameInvalid, "A group name must not contain a slash." },
    { StringKey::BookmarkGroupParentLabel, "Inside:" },
    { StringKey::BookmarkGroupParentRoot,  "- top level -" },
    ...
    { StringKey::TextReadOnlyBadge,             "Read only" },
    { StringKey::TextReadOnlyTip,               "This file is larger than 8 MB. The editor shows only its beginning, so saving is disabled - otherwise the rest of the file would be lost." },
    { StringKey::EditorStatusLineCol,           "Line %1, column %2" },
    { StringKey::EditorStatusLines,             "lines" },
    { StringKey::EditorStatusPlain,             "Text" },
    { StringKey::EditorStatusWrapOn,            "Wrapped" },
    { StringKey::SettingsEditorViewGroup,       "View" },
    { StringKey::SettingsEditorLineNumbers,     "Show line numbers" },
    { StringKey::SettingsEditorCurrentLine,     "Highlight the current line" },
    { StringKey::SettingsEditorSoftWrap,        "Wrap long lines" },
    { StringKey::SettingsEditorSoftWrapHint,    "Only the display wraps - the file is left untouched and a real line break still needs the Enter key. Continuation rows stay blank in the line-number column. Off: the line runs on horizontally." },
    { StringKey::SettingsEditorTabWidth,                "Tab width" },
    { StringKey::SettingsEditorTabSpaces,               "The Tab key inserts spaces" },
    { StringKey::SettingsEditorTabSpacesHint,           "On: the Tab key writes spaces up to the next stop - the way Kate does it, so the file looks the same in every editor regardless of the tab width set there. Off: a real tab character is written, and every editor decides how wide it is." },
    { StringKey::EditorFindPlaceholder,                 "Search …" },
    { StringKey::EditorReplacePlaceholder,              "Replace with …" },
    { StringKey::EditorFindPrev,                        "Previous match (Shift+Enter)" },
    { StringKey::EditorFindNext,                        "Next match (Enter)" },
    { StringKey::EditorFindCase,                        "Match case" },
    { StringKey::EditorFindWords,                       "Whole words only" },
    { StringKey::EditorFindHighlight,                   "Highlight all matches" },
    { StringKey::EditorFindClose,                       "Close search (Esc)" },
    { StringKey::EditorFindReplaceOne,                  "Replace" },
    { StringKey::EditorFindReplaceAll,                  "Replace all" },
    { StringKey::EditorFindNoMatch,                     "No match" },
    { StringKey::EditorFindCounter,                     "%1 / %2" },
    { StringKey::EditorFindReplaced,                    "%1 replaced" },
    { StringKey::EditorMinimap,                         "Overview column" },
    { StringKey::EditorMinimapTip,                      "Show or hide the overview column" },
    { StringKey::EditorMinimapHint,                     "Shows the whole file on the right, heavily scaled down - as coloured bars in the syntax colours rather than as text. It shows the shape of the document (indentation, blocks, blank lines) and you can scroll in it. It costs width, so it is off by default." },
    { StringKey::SettingsEditorExportTitle,                           "Save editor colours" },
    { StringKey::SettingsEditorImportTitle,                           "Load editor colours" },
    ...
    { StringKey::EditorIndentGuidesHint,                              "Vertical lines at each indentation level. In deeply nested code they answer which closing bracket belongs where." },
    { StringKey::EditorMatchBrackets,                                 "Highlight matching brackets" },
    { StringKey::EditorMatchBracketsHint,                             "With the cursor on a bracket, it and its partner are highlighted. If the partner is missing, the bracket turns red - a forgotten bracket is otherwise only found by the compiler." },
    { StringKey::SettingsSearchGroup,                                 "Search with patterns (regular expressions)" },
    { StringKey::SettingsSearchTable,                                 ".\tany character\n\\d\ta digit (\\w letter or digit, \\s whitespace)\n[abc]\tone of these ([^abc] none of these)\n*\tzero or more (+ one or more, ? at most one)\n{4}\texactly four times ({2,5} two to five times)\n^\tstart of line ($ end of line)\na|b\teither a or b\n(…)\ta group\n\\.\ta literal dot - the backslash undoes a special character" },
    { StringKey::SettingsSearchExamples,                              "^#include\tevery include line\n\\d{4}\tevery four-digit number - and the text \\d{4} itself\ncolour|color\tboth at once\n\\.jpg$\tnames ending in .jpg" },
    { StringKey::SettingsDesignBlockUi,                 "Interface" },
    { StringKey::SettingsDesignBlockEditor,             "Text editor" },
    { StringKey::SettingsEditorProfileLabel,            "Editor theme" },
    { StringKey::SettingsEditorSurfaceGroup,            "Surface" },
    { StringKey::SettingsEditorSyntaxGroup,             "Syntax colours" },
    { StringKey::SettingsEditorPreviewGroup,            "Preview" },
    { StringKey::SettingsEditorCustomHint,              "Colours can only be changed in the “Custom” profile. “Copy” takes the current profile there as a starting point." },
    { StringKey::SettingsEditorSeedCustom,              "Copy into Custom" },
    { StringKey::SettingsEditorResetColors,             "Reset" },
    { StringKey::EditorColorBackground,                 "Background" },
    { StringKey::EditorColorText,                       "Text" },
    { StringKey::EditorColorCurrentLine,                "Current line" },
    { StringKey::EditorColorSelection,                  "Selection" },
    { StringKey::EditorColorGutterBackground,           "Line-number column" },
    { StringKey::EditorColorGutterText,                 "Line numbers" },
    { StringKey::EditorColorGutterTextActive,           "Current line number" },
    { StringKey::EditorColorKeyword,                    "Keyword" },
    { StringKey::EditorColorType,                       "Type" },
    { StringKey::EditorColorString,                     "String" },
    { StringKey::EditorColorNumber,                     "Number" },
    { StringKey::EditorColorComment,                    "Comment" },
    { StringKey::EditorColorPreproc,                    "Preprocessor" },
    { StringKey::EditorColorFunction,                   "Function" },
    { StringKey::EditorColorOperator,                   "Operator" },
    { StringKey::EditorColorHeading,                    "Heading" },
    { StringKey::EditorColorEmphasis,                   "Emphasis" },
    { StringKey::EditorColorLink,                       "Link" },
    { StringKey::EditorColorCode,                       "Code" },
