...
static const QMap<StringKey, QString> s_de = {
    ...
    { StringKey::DocxPdfPaddingLabel,       "Zusätzlicher Rand beim PDF-Export" },
    { StringKey::DocxPdfPaddingHint,        "Das Blatt bleibt so groß wie in Word - der Inhalt wird um diesen Rand kleiner gemalt. 0 mm ergibt genau das bisherige Ergebnis." },
    ...
    { StringKey::SettingsDropMoveLabel,  "Ziehen auf ein Lesezeichen verschiebt" },
    { StringKey::SettingsDropMoveDesc,  "Aus: die Datei wird kopiert, das Original bleibt liegen." },
...
static const QMap<StringKey, QString> s_en = {
    ...
    { StringKey::DocxPdfPaddingLabel,       "Extra margin for PDF export" },
    { StringKey::DocxPdfPaddingHint,        "The sheet keeps the size it has in Word - the content is drawn smaller by this margin. 0 mm gives exactly the previous result." },
    ...
    { StringKey::SettingsDropMoveLabel,  "Dropping on a bookmark moves the file" },
    { StringKey::SettingsDropMoveDesc,  "Off: the file is copied and the original stays where it is." },
