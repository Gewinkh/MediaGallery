...
public:
    ...
    // Alle Notizen verwerfen, ohne die Sidecar-Datei zu löschen (der Editor hielte sie im Speicher und schriebe
    // sie zurück): entfernen als EIN Undo-Schritt und sichern - ein leeres Overlay räumt den Sidecar ab.
    ...
    // Zeichen-Session: `beginDraw()` legt die Annotation LIVE an (Vorschau, kein Kommando), `updateDraw()`
    // erweitert live, `endDraw()` finalisiert zu genau EINEM Add-Kommando.
