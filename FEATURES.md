...
- **Only audio filters**: while player mode is on, the filter bar offers just *Audio* and *Video*; leaving the mode restores the filter you had (and, if that is unknown, turns everything back on)
