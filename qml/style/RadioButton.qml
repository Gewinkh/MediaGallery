...
// Ring in Themenfarbe, im Zustand "an" Ring und Punkt in der Akzentfarbe. Geometrie und Abstände wie
// `CheckBox.qml`, damit Auswahl- und Häkchen-Gruppen in den Einstellungen exakt fluchten.
T.RadioButton {
    id: control
